...
describe('Shipment e2e test', () => {
  ...
  /* it('should create and save Shipments', async () => {
        ...
        await promise.all([
            shipmentUpdatePage.setTackingCodeInput('tackingCode'),
        ...
        expect(await shipmentUpdatePage.getTackingCodeInput()).to.eq('tackingCode', 'Expected TackingCode value to be equals to tackingCode');
