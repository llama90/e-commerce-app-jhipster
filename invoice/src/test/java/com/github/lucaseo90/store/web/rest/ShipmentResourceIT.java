...
import com.github.lucaseo90.store.InvoiceApp;
...
public class ShipmentResourceIT {
    ...
    private static final String DEFAULT_TACKING_CODE = "AAAAAAAAAA";
    private static final String UPDATED_TACKING_CODE = "BBBBBBBBBB";
    ...
    public static Shipment createEntity(EntityManager em) {
        Shipment shipment = new Shipment()
            .tackingCode(DEFAULT_TACKING_CODE)
            .date(DEFAULT_DATE)
    ...
    public static Shipment createUpdatedEntity(EntityManager em) {
        Shipment shipment = new Shipment()
            .tackingCode(UPDATED_TACKING_CODE)
            .date(UPDATED_DATE)
    ...
    public void createShipment() throws Exception {
        ...
        assertThat(testShipment.getTackingCode()).isEqualTo(DEFAULT_TACKING_CODE);
    ...
    public void getAllShipments() throws Exception {
        ...
        restShipmentMockMvc.perform(get("/api/shipments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].tackingCode").value(hasItem(DEFAULT_TACKING_CODE)))
    ...
    public void getShipment() throws Exception {
        ...
        restShipmentMockMvc.perform(get("/api/shipments/{id}", shipment.getId()))
            ...
            .andExpect(jsonPath("$.tackingCode").value(DEFAULT_TACKING_CODE))
    ...
    public void updateShipment() throws Exception {
        ...
        Shipment testShipment = shipmentList.get(shipmentList.size() - 1);
        assertThat(testShipment.getTackingCode()).isEqualTo(UPDATED_TACKING_CODE);
