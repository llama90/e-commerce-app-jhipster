package com.github.lucaseo90.store.domain;
...
public class Shipment implements Serializable {
    ...
    public Shipment tackingCode(String tackingCode) {
        this.tackingCode = tackingCode;
        return this;
    }

    public void setTackingCode(String tackingCode) {
        this.tackingCode = tackingCode;
    }
